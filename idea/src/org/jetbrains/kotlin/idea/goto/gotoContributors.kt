...
class KotlinGotoClassContributor : GotoClassContributor {
    ...
    override fun getItemsByName(name: String, pattern: String, project: Project, includeNonProjectItems: Boolean): Array<NavigationItem> {
        ...
        val scope = KotlinSourceFilterScope.sourceAndClassFiles(globalScope, project)
        val classesOrObjects = KotlinClassShortNameIndex.getInstance().get(name, project, scope).filter { it != null && it !is KtEnumEntry }
        ...
        return (classesOrObjects + typeAliases).toTypedArray()
    }
}
